...
type DashboardRole = "creator" | "company" | "admin";

function resolveDashboardRole(input: string | null | undefined): DashboardRole {
  if (input === "creator" || input === "company" || input === "admin") {
    return input;
  }
